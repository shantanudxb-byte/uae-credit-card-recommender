...
body {
  ...
  --color-background-progress-bar-content-default-il6sg6:var(--color-primary-600-1lcy1k);
  --color-background-progress-bar-content-in-flash-98s7uz:var(--color-white-p1zlvy);
  --color-background-progress-bar-layout-default-z3ipl1:var(--color-neutral-250-vs1is4);
  ...
  --color-background-slider-error-pressed-79f2kg:var(--color-error-900-skonp1);
  --color-background-slider-warning-pressed-j1qp7g:var(--color-warning-900-kpxt8c);
...
@media not print {
  .awsui-dark-mode:not(#\9) {
    ...
    --color-background-progress-bar-content-default-il6sg6:var(--color-primary-400-n8h4bx);
    --color-background-progress-bar-layout-default-z3ipl1:var(--color-neutral-700-qw8ats);
    ...
    --color-background-slider-error-pressed-79f2kg:var(--color-error-400-c0knb8);
    --color-background-slider-warning-pressed-j1qp7g:var(--color-warning-500-zidhub);
...
.awsui-context-flashbar-warning:not(#\9) {
  ...
  --color-background-progress-bar-content-in-flash-98s7uz:var(--color-neutral-950-lxybh8);
...
:root {
  --awsui-version-info-e4cf4d53: true;
}