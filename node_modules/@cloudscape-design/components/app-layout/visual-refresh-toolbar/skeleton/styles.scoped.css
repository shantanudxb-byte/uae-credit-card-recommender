...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_7nfqu_1df5g_153:not(#\9) {
...
@media (min-width: 689px) {
  ...
  .awsui_root_7nfqu_1df5g_153.awsui_has-adaptive-widths-default_7nfqu_1df5g_197:not(#\9) {
    --awsui-max-content-width-rhu47t: 1620px;
  }
}
@media (min-width: 689px) and (min-width: 1401px) {
  .awsui_root_7nfqu_1df5g_153.awsui_has-adaptive-widths-dashboard_7nfqu_1df5g_202:not(#\9) {
...
@media (min-width: 689px) {
  .awsui_root_7nfqu_1df5g_153.awsui_drawer-expanded-mode_7nfqu_1df5g_217:not(#\9) {
    grid-template-columns: 0 0 0 0 0 0 0 auto;
  }
  .awsui_root_7nfqu_1df5g_153.awsui_drawer-expanded-mode_7nfqu_1df5g_217.awsui_ai-drawer-expanded-mode_7nfqu_1df5g_220:not(#\9) {
    grid-template-columns: auto 0 0 0 0 0 0 0;
  }
  .awsui_root_7nfqu_1df5g_153.awsui_drawer-expanded-mode_7nfqu_1df5g_217.awsui_bottom-drawer-expanded-mode_7nfqu_1df5g_223:not(#\9) {
    grid-template-rows: auto;
    grid-template-columns: 0 0 0 0 0 auto 0 0;
  }
}

.awsui_ai-drawer_7nfqu_1df5g_220:not(#\9),
.awsui_navigation_7nfqu_1df5g_230:not(#\9),
.awsui_tools_7nfqu_1df5g_231:not(#\9),
.awsui_global-tools_7nfqu_1df5g_232:not(#\9),
.awsui_bottom-tool_7nfqu_1df5g_233:not(#\9) {
  grid-row: 1/-1;
  grid-column: 1/-1;
...
@media (min-width: 689px) {
  ...
  .awsui_tools_7nfqu_1df5g_231:not(#\9):not(:has(> [data-testid])) {
    inline-size: var(--awsui-tools-width-rhu47t);
  }
  .awsui_tools_7nfqu_1df5g_231:not(#\9):not(:has(> [data-testid])).awsui_tools-open_7nfqu_1df5g_290 {
...
@media (min-width: 689px) {
  .awsui_split-panel-side_7nfqu_1df5g_304:not(#\9) {
...
.awsui_split-panel-bottom_7nfqu_1df5g_311:not(#\9) {
  position: sticky;
  z-index: 840;
  align-self: end;
  grid-area: main;
...
.awsui_panel-hidden_7nfqu_1df5g_324:not(#\9) {
  border-block: none;
  border-inline: none;
  opacity: 0;
  z-index: 0;
}
.awsui_panel-hidden_7nfqu_1df5g_324.awsui_navigation_7nfqu_1df5g_230:not(#\9), .awsui_panel-hidden_7nfqu_1df5g_324.awsui_tools_7nfqu_1df5g_231:not(#\9), .awsui_panel-hidden_7nfqu_1df5g_324.awsui_global-tools_7nfqu_1df5g_232:not(#\9) {
  inline-size: 0px;
}

.awsui_toolbar-container_7nfqu_1df5g_334:not(#\9) {
  grid-area: toolbar;
  block-size: 42px;
...
.awsui_notifications-container_7nfqu_1df5g_341:not(#\9) {
  grid-area: notifications;
}

.awsui_notifications-background_7nfqu_1df5g_345:not(#\9) {
...
.awsui_main-landmark_7nfqu_1df5g_356:not(#\9) {
  display: contents;
}

.awsui_main_7nfqu_1df5g_356:not(#\9) {
  grid-area: main;
  margin-block-start: var(--space-scaled-s-8ozaad, 12px);
  margin-block-end: var(--space-layout-content-bottom-zeb1g9, 40px);
}
.awsui_main-disable-paddings_7nfqu_1df5g_365:not(#\9) {
  margin-block: 0;
  grid-column: 1/-1;
}
@media (min-width: 689px) {
...
.awsui_content-header_7nfqu_1df5g_375:not(#\9) {
  margin-block-end: var(--space-content-header-padding-bottom-rvy5xz, 16px);
}

.awsui_content_7nfqu_1df5g_375:not(#\9) {
  display: contents;
}

/* stylelint-disable-next-line selector-combinator-disallowed-list, selector-max-universal */
@media (max-width: 688px) {
  .awsui_unfocusable-mobile_7nfqu_1df5g_385 *:not(#\9) {
    visibility: hidden;
  }
}

.awsui_hidden_7nfqu_1df5g_390:not(#\9) {
  display: none;
}

.awsui_breadcrumbs-own_7nfqu_1df5g_394:not(#\9):not(:empty) + .awsui_breadcrumbs-discovered_7nfqu_1df5g_394 {
  display: none;
}