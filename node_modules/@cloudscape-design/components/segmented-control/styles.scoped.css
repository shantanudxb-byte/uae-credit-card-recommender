...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_segment_8cbea_191y5_161:not(#\9) {
  ...
  background: var(--awsui-style-background-default-rhu47t, var(--color-background-segment-default-b0r494, #ffffff));
  color: var(--awsui-style-color-default-rhu47t, var(--color-text-segment-default-vi2vn9, #424650));
  overflow: visible;
...
.awsui_segment_8cbea_191y5_161:not(#\9):not(.awsui_refresh_8cbea_191y5_188) {
  block-size: calc(100% - var(--space-static-xxs-ns94dp, 4px) - 2 * var(--border-width-field-2xc78x, 1px));
}
.awsui_segment_8cbea_191y5_161:not(#\9):focus {
  outline: none;
}
.awsui_segment_8cbea_191y5_161.awsui_disabled_8cbea_191y5_194:not(#\9) {
  background: var(--awsui-style-background-disabled-rhu47t, var(--color-background-segment-disabled-m2a5t7, #ffffff));
  color: var(--awsui-style-color-disabled-rhu47t, var(--color-text-interactive-disabled-1bqmrl, #b4b4bb));
}
body[data-awsui-focus-visible=true] .awsui_segment_8cbea_191y5_161:not(#\9):focus {
  position: relative;
}
body[data-awsui-focus-visible=true] .awsui_segment_8cbea_191y5_161:not(#\9):focus {
...
body[data-awsui-focus-visible=true] .awsui_segment_8cbea_191y5_161:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
...
.awsui_segment_8cbea_191y5_161:not(#\9):not(:last-child)::after {
  content: "";
  position: absolute;
...
.awsui_segment_8cbea_191y5_161:not(#\9):not(.awsui_refresh_8cbea_191y5_188):not(:last-child)::after {
  inset-inline-end: calc(-1 * var(--space-static-xxs-ns94dp, 4px));
}
.awsui_segment_8cbea_191y5_161:not(#\9):nth-child(1) {
  grid-column: 1;
}
.awsui_segment_8cbea_191y5_161:not(#\9):nth-child(2) {
  grid-column: 2;
}
.awsui_segment_8cbea_191y5_161:not(#\9):nth-child(3) {
  grid-column: 3;
}
.awsui_segment_8cbea_191y5_161:not(#\9):nth-child(4) {
  grid-column: 4;
}
.awsui_segment_8cbea_191y5_161:not(#\9):nth-child(5) {
  grid-column: 5;
}
.awsui_segment_8cbea_191y5_161:not(#\9):nth-child(6) {
  grid-column: 6;
}
.awsui_segment_8cbea_191y5_161.awsui_selected_8cbea_191y5_251:not(#\9) {
  background: var(--awsui-style-background-active-rhu47t, var(--color-background-segment-active-1u2ldl, #006ce0));
  color: var(--awsui-style-color-active-rhu47t, var(--color-text-segment-active-hlorbe, #ffffff));
}
.awsui_segment_8cbea_191y5_161:not(#\9):hover:not(.awsui_selected_8cbea_191y5_251):not(.awsui_disabled_8cbea_191y5_194):not(:focus) {
  background: var(--awsui-style-background-hover-rhu47t, var(--color-background-segment-hover-800sl4, #f0fbff));
  color: var(--awsui-style-color-hover-rhu47t, var(--color-text-segment-hover-65a2x8, #002b66));
  cursor: pointer;
}

.awsui_icon_8cbea_191y5_261:not(#\9) {
  /* used in test-utils */
}

.awsui_with-text_8cbea_191y5_265:not(#\9) {
  position: relative;
  inset-inline-start: calc(-1 * var(--space-xxs-hwfkai, 4px));
  margin-inline-end: var(--space-xxs-hwfkai, 4px);
}

.awsui_with-no-text_8cbea_191y5_271:not(#\9) {
  margin-inline: auto;
  inset-inline: 0;
}

.awsui_root_8cbea_191y5_276:not(#\9) {
...
.awsui_segment-part_8cbea_191y5_308:not(#\9) {
  display: inline-grid;
...
.awsui_segment-part_8cbea_191y5_308:not(#\9):not(.awsui_refresh_8cbea_191y5_188) {
...
.awsui_select_8cbea_191y5_251:not(#\9) {
  display: none;
}
@media (max-width: 688px) {
  .awsui_select_8cbea_191y5_251:not(#\9) {
...
.awsui_segment-count-2_8cbea_191y5_343:not(#\9) {
  grid-template-columns: repeat(2, auto);
}

.awsui_segment-count-3_8cbea_191y5_347:not(#\9) {
  grid-template-columns: repeat(3, auto);
}

.awsui_segment-count-4_8cbea_191y5_351:not(#\9) {
  grid-template-columns: repeat(4, auto);
}

.awsui_segment-count-5_8cbea_191y5_355:not(#\9) {
  grid-template-columns: repeat(5, auto);
}

.awsui_segment-count-6_8cbea_191y5_359:not(#\9) {
  grid-template-columns: repeat(6, auto);
}

.awsui_disabled-reason-tooltip_8cbea_191y5_363:not(#\9) {
